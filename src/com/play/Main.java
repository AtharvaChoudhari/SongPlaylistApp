...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("Jhoome Jo Pathaan",3.2);
        album.addSong("Apna Bana Le",4.2);
        album.addSong("Deva Deva",4.4);
        albums.add(album);

        album = new Album("Album2","Armaan Malik");

        album.addSong("Hawaa Banke",4.3);
        album.addSong("Chale Aana",4.3);
        ...
        albums.get(0).addToPlayList("Jhoome Jo Pathaan",playList_1);
        albums.get(0).addToPlayList("Apna Bana Le",playList_1);
        albums.get(1).addToPlayList("Pehla Pyaar",playList_1);
